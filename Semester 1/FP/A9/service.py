        ...
        for row in range(6):
            for column in range(4):
                if board.matrix[row][column] != '●':
                    if board.matrix[row][column] == board.matrix[row][column + 1] and board.matrix[row][column] == \
                            board.matrix[row][column + 2] and board.matrix[row][column] == board.matrix[row][
                        column + 3]:
                        return True
        for column in range(7):
            for row in range(3):
                if board.matrix[row][column] != '●':
                    if board.matrix[row][column] == board.matrix[row + 1][column] and board.matrix[row][column] == \
                            board.matrix[row + 2][column] and board.matrix[row][column] == board.matrix[row + 3][
                        column]:
                        return True
        for row in range(3):
            for column in range(4):

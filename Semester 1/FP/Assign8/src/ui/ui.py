...
class UI:
    ...
    def assign_to_student_s_ui(self):
        ...
        for index in range(len(students)):
            student_ids.append(int(students[index].student_id))
        ...
        for index in range(len(assignments)):
            assignment_ids.append(int(assignments[index].assignment_id))
        for id_ in assignment_ids:
            print(str(id_))
        assignment_id = int(input("What assignment do you want to give? Enter the id: "))
    ...
    def remove_assigned_ui(self):
        ...
        student_id = int(input("Enter the id of the student: "))
        assignment_id = int(input("What assignment do you want to remove? Enter the id: "))
        if student_id in student_ids:
            if assignment_id in assignment_ids:
    ...
    def grade_assignment_ui(self):
        ...
        student_id = int(input("Enter the student you want to grade: "))
        if student_id not in unique_students:
            ...
            for index in range(len(assignments)):
                print(str(assignments[index]) + ", " + grade_type[index]['status'])
            assignment_id = int(input("Enter the id of the assignment you want to grade: "))
        ...
        for index in range(len(unique_assignments)):
            ...
            for index1 in range(len(unique_students)):
                if unique_students[index1][1] != 0:
                    print(str(unique_students[index1][0]) + "     -------------   " + str(unique_students[index1][1]))
                elif unique_students[index1][1] == 0:
                    print(str(unique_students[index1][0]) + "     ---------- ungraded")
    ...
    def statistics_3_ui(self):
        ...
        for index in range(len(best_students)):
            if best_students[index][1] != 0:
                ...
                print("Student ID: {}, this student is late for all assignments, average grade is 0.".format(
                    best_students[index][0]))

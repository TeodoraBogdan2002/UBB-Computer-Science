...
GO
IF OBJECT_ID(N'dbo.producer', N'U') IS NOT NULL  
...
CREATE TABLE employees(id_employees int PRIMARY KEY NOT NULL, 
                       id_contract INT FOREIGN KEY REFERENCES contract_em(id_contract) ON DELETE CASCADE ON UPDATE CASCADE,
...
ADD CONSTRAINT FK_employee_costumer FOREIGN KEY([id_employees]) 

...
function load1stLevelFriends() {
    let table = $('#1stLevelFriends').DataTable();
    $.getJSON('Friends/getFriends.php?level=1', function( data ) {
        console.log(data);
        table.clear();
        table.rows.add(data);
        table.draw();
...
function load2ndLevelFriends() {
    let table = $('#2ndLevelFriends').DataTable();
    $.getJSON('Friends/getFriends.php?level=2', function( data ) {
        console.log(data);
        table.clear();
        table.rows.add(data);
        table.draw();
...
function makeFriends(friend) {
    console.log(friend);
    $.post('Friends/makeFriends.php?friend=' + friend, function () {
        load1stLevelFriends();
        load2ndLevelFriends();
    })
}
...
function removeFriends(friend) {
    console.log(friend);
    $.post('Friends/removeFriends.php?friend=' + friend, function () {
        load1stLevelFriends();
        load2ndLevelFriends();
    })
}
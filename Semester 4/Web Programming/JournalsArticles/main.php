...
<?php 
    ...
    $mysqli = new mysqli('localhost','root','','journalsarticles') or die(mysqli_error($mysqli));
    ...
    if(isset($_POST['search'])) {
        ...
        $sql = "SELECT * FROM Articles WHERE user = '{$_SESSION['User']}' AND journalid = '$search_term'";
...
<form name="search_form" action="main.php" method="POST" class="form-filter">
    <label>Filter by journalid:&nbsp;</label>
    <input type="text" name="search_box" placeholder="Enter journal id" value="">

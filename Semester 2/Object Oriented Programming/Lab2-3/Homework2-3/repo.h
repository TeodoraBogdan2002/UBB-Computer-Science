...
void add_product_repository(Repository* r, char name[], char type[], int quantity, char date[]);
...
int delete_product_repository(Repository* r, char name[], char type[]);
...
int update_products_quantity_repository(Repository* r, char name[], char type[], int quantity);
...
/// \return returns 1 if the product was updated successfully and 0 otherwise
int update_products_expiration_date_repository(Repository* r, char name[], char type[], char date[]);
...
void search_elements_by_string_repository(Repository* r, char string[], Repository* repository);
...
int search_elements_by_category_repository(Repository* r, char string[], Repository* repository);

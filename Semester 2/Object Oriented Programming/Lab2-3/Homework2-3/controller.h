...
{
    Repository repo;
    UndoRepository undo_redo;

} Service;

Service* createService(Repository repository, UndoRepository UndoRedo);
...
void add_product_service(Service* service, char name[], char type[], int quantity, char date[]);
...
int search_elements_by_category_service(Service* service, char string[], Repository* repository, int number_of_days);
